    ...
    <div className="App">
      ...
      <body className="weather-content">
        <div className="real-weather">
          <img className="live-weather" src={mostlycloudy} alt="mostlycloudy icon" />
        ...
        <div className="full-day-weather">
          <div className="weather-3">
            <span>03:00</span>
            <img className="image-3" src={mostlycloudy} alt="mostlycloudy icon"/>
            <span>8°C</span>
          </div>
          <div className="weather-6">
            <span>06:00</span>
            <img className="image-6" src={mostlycloudy} alt="mostlycloudy icon"/>
            <span>9°C</span>
          </div>
          <div className="weather-9">
            <span>09:00</span>
            <img className="image-9" src={clear} alt="clear icon"/>
            <span>14°C</span>
          </div>
          <div className="weather-12">
            <span>12:00</span>
            <img className="image-12" src={clear} alt="clear icon"/>
            <span>17°C</span>
          </div>
          <div className="weather-15">
            <span>15:00</span>
            <img className="image-15" src={clear} alt="clear icon"/>
            <span>18°C</span>
          </div>
          <div className="weather-18">
            <span>18:00</span>
            <img className="image-18" src={clear} alt="clear icon"/>
            <span>16°C</span>
          </div>
          <div className="weather-21">
            <span>21:00</span>
            <img className="image-21" src={mostlycloudy} alt="mostlycloudy icon"/>
            <span>13°C</span>
          </div>
        </div>
      </body>
